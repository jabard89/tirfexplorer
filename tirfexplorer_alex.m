...
if handles.driftToggle
    ...
    case 'left'
        set(handles.plots.donorRef,'XData',handles.refPeak(1,1),...
            'YData',handles.refPeak(1,2));
    case 'right'
        if handles.alexToggle
            set(handles.plots.acceptorRef,'XData',handles.refPeak(1,1),...
                'YData',handles.refPeak(1,2));
        else
            set(handles.plots.fretRef,'XData',handles.refPeak(1,1),...
                'YData',handles.refPeak(1,2));
        end
    end
end
